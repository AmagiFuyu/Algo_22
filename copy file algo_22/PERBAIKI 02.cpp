...
struct iQIYI {
    ...
    char tanya;
    int pil, bayar, pin_biasa, beliberapa, hargatotal, no_hp, pilcrede, nocrede, pinkartu, add, time, i;
    string mohon_di_tunggu[3]={"Processing.", ".", "Done"};
};
    void delay( int a){
    int add;
    int time;
 ...
 void MohonDitunggu(){
    ...
    case 7:
        ...
        break;
    default:
    	vip.langganan = "\x1b[1mSalah Input\x1b[0m";
    	vip.hargatotal = 0;
        break;
    }
   MohonDitunggu();
...
int main(){
    ...
    atas:
   	pembuka();  
	pemilihan();
    vip.nama = "Bertransaksi";
    cout<<"Apakah Anda Ingin " << vip.nama << " Lagi (y/t)? "; cin>>vip.tanya;
    if(vip.tanya == 'y'){
    	system("cls");
		goto atas;
	}
